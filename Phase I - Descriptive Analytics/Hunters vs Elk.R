#' ---
#' title: "Elk Populations and Number of Hunters in Hunting Units"
...
ggplot(COElk.Hunters.Population.Statewide, aes(Hunters,Population)) +
  geom_point(size=5) +
  labs(title="Statewide Elk Hunters vs Elk Population", caption="source: cpw.state.co.us")

COElkHuntersPopulation$Elk_per_Hunter <- COElkHuntersPopulation$Unit_Pop / COElkHuntersPopulation$Hunters

#' There were many hunters in 2006, the total drastically reduced to the lowpoint in 2009.
#' Since then, the number slightly increased to 2013, and reset again the next year. In recent years the number of hunters has 
#' again continued to increase slightly.
#' 
#' ## Hunters by Unit
